...
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="images/teeth.png" width="30px" height="30px"><strong> Sidlabs </strong>Appointment Booking System</a></li>
			...
			<div class="footer">
				<ul style="position:absolute;top:93%;background-color:black">
					...
					<li><a href="admin/mlogin.php">Manager Login(Clerk)</a></li>
				</ul>
			</div>
